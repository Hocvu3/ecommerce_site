            ...
            <form action="{{ route('admin.payment-settings.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="paypal_currency" id="" class="select2 form-control">
                        <option value="">Select</option>
                        <option @selected(@$paymentGateway['paypal_currency'] === 'USD') value="USD">USD</option>
                        <option @selected(@$paymentGateway['paypal_currency'] === 'EURO') value="EURO">EURO</option>
                        <option @selected(@$paymentGateway['paypal_currency'] === 'VND') value="VND">VND</option>
                    </select>
                </div>
